...
Unlike the [collaboration](./collaboration.md) and [coordination](./coordination.md) scales, which focus on smaller, more tightly coupled [groups](../../../../tags/groups.md) and sets of groups, Constituency Scale emphasizes participation, representation, and collective [decision-making](../../../../tags/decisions.md) across a wider [community](../../../../tags/community.md). This can range into the millions for a democratic nation. But can also be relatively small numbers, for example a small DAO [network](../../../../tags/networks.md).
...
However, there is a necessary trade-off between scale and the complexity of decisions that it can handle. [Collaboration](./collaboration.md) scale can handle complexity, nuance, tension, etc., [coordination](./coordination.md) scale is more constrained and only able to make more formal decisions (usually that have bubbled up as options from collaboration scale groups). Constituency scale is more constrained still. At large numbers, there is little scope for complex [decision-making](../../../../tags/decisions.md) and usually simple voting mechanisms are used.
...
- **Wrapping Smaller Scales**: Usually constituency scale [governance](../../../../tags/governance.md) will wrap smaller scale operational structures. For example, it will act as the [community](../../../../tags/community.md) governance wrapper that will support [coordination](./coordination.md) and [collaboration](./collaboration.md) scale operational groups.
...
### Constituency Scale [Primitives](../../../../tags/primitives.md)
