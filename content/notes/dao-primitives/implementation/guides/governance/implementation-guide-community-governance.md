...
- [Implementation-guide-community-governance](/content/artifacts/guides/dao-primitives-framework/dao-primitives-implemention/implementation-guide-community-governance.md#) (this guide)
========
...
In this DAO Primitives context, Community governance exists as part of a three-layers governance model that occur at three different [[/content/tags/groups#Groups at Different Scales|layers of scale]]:
...
- **[[/content/tags/coordination|Coordination]] at Scale**: How to make collective decisions as networks grow beyond face-to-face and small group interaction scales
...
3. **[[/content/tags/roles|Roles]]** - which contain and manage specific responsibilities and sets of permissions
...
You may want to or have already created an impact model (or theory of change) to describe the way you want your network to have positive impact on the world. It is not necessary to do this right away, as in the early phases ([[/content/tags/groups#Groups in Developmental Phases|conversation and formation phases]]) of developing a community governance structure these details may still be emerging. But it is recommended to have a clearly articulated impact model as you move into coordination and organization phases. This will ensure that you have a solid coherent and testable foundation to connect your network's purpose to actual measurable change in the world.
...
5. **Technical Considerations**: What technical factors shape the implementation options?
    - [[/content/artifacts/articles/network-evolution/Building DAOs as scalable networks#Community Governance|On-chain vs. off-chain]] processes
    - Available tooling
...
1. **[[/content/artifacts/articles/network-evolution/Building DAOs as scalable networks#Community Governance|Token-based governance]]**
...
2. **Reputation-Based Governance**
    ...
    - Key Primitives: [[/content/tags/attestations|Attestations]], contribution tracking, reputation algorithms
...
4. **Council Governance**
    - Description: Selected group with defined [[/content/tags/responsibilities|responsibilities]] and constraints
...
5. **Sortition-Based Governance**
    - Description: Random selection of participants for decision-making [[/content/tags/roles|roles]]
...
7. **Quadratic Governance**
    ...
    - Key Primitives: [[/content/artifacts/articles/governance-for-better-futures/Governance for better futures - Meta-governance#quadratic voting|quadratic voting]], funding mechanisms, identity verification
...
1. **Selected Patterns**: Which governance patterns you've chosen to incorporate a. You can select defined patterns from the SuperBenefit Knowledge Garden here [[/content/artifacts/patterns/index|patterns]]
...
- Developing [[/content/tags/policies|policies]] e.g codes of conduct, conflict resolution processes etc
...
1. Implement teams, squads, [[/content/tags/roles|Cells]] and [[/content/tags/roles|roles]] etc to manage ongoing community governance functions
...
3. **[[/content/tags/roles|Role]] Descriptions**: Clear documentation of governance [[/content/tags/roles|roles]] and [[/content/tags/responsibilities|responsibilities]]
4. **Process Maps**: Visual representations of key governance processes
5. **[[/content/tags/policies|Policies]]**: Explicit guidelines governing community behavior
...
See [[/content/notes/dao-primitives/implementation/patterns/dao-patterns/dao-state|dao-state]] for details on implementing state documentation for a community governance structure
...
Implementing governance requires creating specific structures that enable [[/content/tags/coordination|coordination]] and decision-making.
...
3. **Working Groups**
    ...
    - Documented [[/content/tags/coordination|coordination]] with broader governance
    - Appropriate autonomy balanced with accountability
    - DAO primitives framework uses [[/content/tags/roles|Cells]] as a working group primitive
4. **Advisory Councils**
...
1. **[[/content/artifacts/articles/network-evolution/Building DAOs as scalable networks#Community Governance|On-chain vs. off-chain governance]]**
...
3. [[/content/tags/groups#Groups in Developmental Phases|Organisation Phase]]
