...
1. **Selected Patterns**: Which governance patterns you've chosen to incorporate a. You can select defined patterns from the SuperBenefit Knowledge Garden here [patterns](/content/artifacts/patterns/_index.md#)
...
See [dao-state](/content/notes/dao-primitives/implementation/patterns/dao-patterns/dao-state.md#) for details on implementing state documentation for a community governance structure
