...
At SuperBenefit we have developed the [DAO primitives framework](/content/artifacts/guides/dao-primitives-framework/DAO%2520Primitives%2520Conceptual%2520Framework.md#) to provide a set of primitives and patterns with which these new organizational structures can be composed.

We have identified and experimented with using the DAO primitives framework to produce governance systems based on 3 interlocking governance structures: [Community Governance](/content/tags/Decentralized%2520Governance.md#), [Operational Governance](/content/tags/Decentralized%2520Governance.md#.md#) and [Multi-Stakeholder Governance](multi-stakeholder-governance.md#).
...
- [Implementation-guide-operational-governance](/content/artifacts/guides/dao-primitives-framework/dao-primitives-implemention/Implementation%2520Guide%2520for%2520Operational%2520Governance.md#) (this guide)
- [Implementation-guide-multi-stakeholder-governance](/content/artifacts/guides/dao-primitives-framework/dao-primitives-implemention/Implementation%2520Guide%2520for%2520Multi-Stakeholder%2520Governance.md#)
- [Implementation-guide-community-governance](/content/artifacts/guides/dao-primitives-framework/dao-primitives-implemention/Implementation%2520Guide%2520for%2520Community%2520Governance.md#)
========
- [Implementation-guide-operational-governance](Implementation%2520Guide%2520for%2520Operational%2520Governance.md#) (this guide)
- [Implementation-guide-multi-stakeholder-governance](/content/notes/dao-primitives/implementation/guides/governance/Implementation%2520Guide%2520for%2520Multi-Stakeholder%2520Governance.md#)
- [Implementation-guide-community-governance](/content/notes/dao-primitives/implementation/guides/governance/Implementation%2520Guide%2520for%2520Community%2520Governance.md#)
...
- [DAO](/content/tags/Decentralized%2520Autonomous%2520Organizations%2520(DAOs).md#) contributors working to create more effective [coordination](/content/tags/Coordination.md#) systems
...
The [DAO primitives framework](/content/artifacts/guides/dao-primitives-framework/DAO%2520Primitives%2520Conceptual%2520Framework.md#) is designed to allow us to compose governance systems that produce purpose-aligned networks of small autonomous teams with powerful organizational dynamics, making these networks effective in solving important problems.
...
The [DAO primitives framework](/content/artifacts/guides/dao-primitives-framework/DAO%2520Primitives%2520Conceptual%2520Framework.md#) provides 4 fundamental building blocks for creating effective decentralized organizations:

1. **[DAOs](/content/tags/Decentralized%2520Autonomous%2520Organizations%2520(DAOs).md#.md#)** - the larger constituency scale community container that the operational governance operates inside
2. **[Cells](/content/tags/Roles.md#)** - the basic operational unit in a DAO - a small autonomous team
3. **[Roles](/content/tags/Roles.md#.md#)** - which contain and manage specific [responsibilities](/content/tags/Responsibilities.md#) and sets of permissions
...
- **Phase** - each DAO, Cell, Role or Task can move through a [group phase lifecycle](/content/tags/Groups.md##groups-in-developmental-phases)
- **Scale** - different organizational levels from [collaboration to coordination to constituency](/content/tags/Groups.md##groups-at-different-scales) to network
...
Using the [DAO primitives framework](/content/artifacts/guides/dao-primitives-framework/DAO%2520Primitives%2520Conceptual%2520Framework.md#) to create a purpose aligned network of small autonomous teams, there tend to be three facets of governance structure.

1. **[Community Governance](/content/tags/Decentralized%2520Governance.md##community-governanceartifactspatternscommunity-governancemd)**: [constituency scale](/content/tags/Groups.md.md##groups-at-different-scales) governance that guides and protects the network
2. **[Operational Governance](/content/tags/Decentralized%2520Governance.md##operational-governanceartifactspatternsoperational-governancemd)**: [coordination and collaboration scale](/content/tags/Groups.md.md.md##groups-at-different-scales) governance that effectively executes on the purpose and goals of the community governance
3. **[Multi-Stakeholder Governance](/content/tags/Decentralized%2520Governance.md##multi-stakeholder-governance)**: the mechanism by which the network can connect to and partner with other organizations and networks (network scale)

The operational governance model forms the coordinating backbone of a [DAO](/content/tags/Decentralized%2520Autonomous%2520Organizations%2520(DAOs).md#) network, translating community-defined purpose into effective execution through autonomous teams. It operates at the [coordination and collaboration scales](/content/tags/Groups.md.md.md.md##groups-at-different-scales), creating the organizational infrastructure that enables small autonomous teams to work together coherently while maintaining the flexibility and innovation that comes from decentralized decision-making.
...
2. **[Coordination](/content/tags/Coordination.md#.md#)**: The network of coordinating structures that enable [Cells](/content/tags/Roles.md#) to work together, share resources, develop strategy, and maintain coherence across the operational network while preserving Cell autonomy.
...
There are many ways to use the [DAO primitives](/content/artifacts/guides/dao-primitives-framework/DAO%2520Primitives%2520Conceptual%2520Framework.md#.md#.md#.md#.md#) to compose a network of operational teams. The particular system you create will reflect the specific needs of the work your community wants to engage in.
...
You may want to or have already created an impact model (or theory of change) to describe the way you want your network to have positive impact on the world. It is not necessary to do this right away, as in the early [phases](/content/tags/Groups.md.md##groups-in-developmental-phases) of developing your governance structure these details may still be emerging. But it is recommended to have a clearly articulated impact model as you move into [coordination and organization phases](/content/tags/Groups.md.md.md##groups-in-developmental-phases). This will ensure that you have a solid coherent and testable foundation to connect your network's purpose to actual measurable change in the world.
...
2. **Decision Scope**: What types of decisions need operational governance?
    ...
    - [Coordination](/content/tags/Coordination.md#.md#) between [cells](/content/tags/Roles.md#.md#.md#.md#.md#)
    - Conflict resolution between teams
3. **Stakeholder Inclusion**: Who needs representation in operational governance?
    - [Cell](/content/tags/Roles.md#.md#.md#.md#.md#.md#) leads/representatives
    - Team members
...
1. **Highly structured top-down decision-making**
    ...
    - Build hierarchies of [cells](/content/tags/Roles.md#.md#.md#.md#.md#.md#.md#) that answer to cells above them
...
2. **Highly unconstrained networks**
    ...
    - Free-forming of [cells](/content/tags/Roles.md#.md#.md#.md#.md#.md#.md#) that coordinate without constraints from the larger network
...
See [patterns](/content/artifacts/patterns/Pattern%2520Library.md#) for different approaches to building operational structures with the DAO Primitives.

#### Activity: Community-Operational Boundary Design

Using the [DAO primitives framework](/content/artifacts/guides/dao-primitives-framework/DAO%2520Primitives%2520Conceptual%2520Framework.md#), design a structure that implements a network of operational [Cells](/content/tags/Roles.md#). It needs to cover four different levels of scale:

1. **Community governance level ([constituency scale](/content/tags/Groups.md.md.md.md.md##groups-at-different-scales))**
    ...
    - _See [Community Governance](/content/tags/Decentralized%2520Governance.md##community-governanceartifactspatternscommunity-governancemd) pattern and implementation guide_
2. **Cell coordination level ([coordination scale](/content/tags/Groups.md.md.md.md.md.md##groups-at-different-scales))**
    - How the operational network connects with community governance
        - Perhaps via a top-level [Cell](/content/tags/Roles.md#.md#.md#.md#.md#.md#) that takes instruction from community governance
...
3. **Cell level ([collaboration scale](/content/tags/Groups.md.md.md.md.md.md.md##groups-at-different-scales))**
    - Define minimum information standards (state) expected of [Cells](/content/tags/Roles.md#)
    - Create templates or archetypal [Cell](/content/tags/Roles.md#.md#.md#.md#.md#.md#) types to standardize new Cells
4. **Partnerships level (network scale)**
    ...
    - _See [Multi-Stakeholder Governance](/content/tags/Decentralized%2520Governance.md##multi-stakeholder-governance) Implementation Guide_
...
4. **[Roles](/content/tags/Roles.md#.md#) and [Responsibilities](/content/tags/Responsibilities.md#.md#)**: Key functions within the governance system
5. **Resource Allocation**: How governance will manage organizational resources
6. **Boundaries and Constraints**: Limits on governance authority and [Cell](/content/tags/Roles.md#.md#.md#.md#.md#.md#) autonomy
...
2. Set up core [coordination](/content/tags/Coordination.md#.md#.md#.md#) primitives (basic [agreements](/content/tags/Agreements.md#) and protocols)
3. Establish foundational [roles](/content/tags/Roles.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#) and [responsibilities](/content/tags/Responsibilities.md#.md#.md#)
...
Use the concept of [group phase](/content/tags/Groups.md.md.md.md##groups-in-developmental-phases) to implement your governance structure in an evolutionary way, formalizing [Cells](/content/tags/Roles.md#) and other primitives as they are ready, rather than forcing a completed governance design all at once.

#### Conversation Phase

During this initial [phase](/content/tags/Groups.md.md.md.md.md##groups-in-developmental-phases), focus on:
...
As implementation progresses, the [formation phase](/content/tags/Groups.md.md.md.md.md.md##groups-in-developmental-phases) includes:

- Formalizing core [agreements](/content/tags/Agreements.md#.md#), communication and meeting protocols
- Establishing initial [roles](/content/tags/Roles.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#) and [responsibilities](/content/tags/Responsibilities.md#.md#.md#)
...
2. Establish critical [roles](/content/tags/Roles.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#) and select/elect initial occupants
...
In this [phase](/content/tags/Groups.md.md.md.md.md##groups-in-developmental-phases), focus on:
...
In the final implementation [phase](/content/tags/Groups.md.md.md.md.md##groups-in-developmental-phases), establish:

- Ongoing community engagement/participation in governance
- Ongoing upkeep of documentation and systems
- Ongoing management of governance [roles](/content/tags/Roles.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#) and authorities
- Continued processes for governance feedback and evolution

**Key Activities:**

1. Implement teams, squads, [Cells](/content/tags/Roles.md#) and [roles](/content/tags/Roles.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#) to manage ongoing governance functions
...
4. **[Role](/content/tags/Roles.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#) Descriptions**: Clear documentation of governance [roles](/content/tags/Roles.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#) and [responsibilities](/content/tags/Responsibilities.md#.md#.md#)
5. **Process Maps**: Visual representations of key governance processes
6. **[Policies](/content/tags/Policies.md#.md#)**: Explicit guidelines governing community behavior
...
2. **Tool Selection** Here are some potential tool options for different core operational governance functions: a. **Knowledge repository**
    ...
    b. **[Cell](/content/tags/Roles.md#.md#.md#.md#.md#.md#) state repository**
    
    - A mechanism for containing and updating [Cell](/content/tags/Roles.md#.md#.md#.md#.md#.md#) state
...
3. **Implementation Approach**
    - Start with minimum viable governance tools as required by the [phase](/content/tags/Groups.md.md.md.md.md##groups-in-developmental-phases) of development
...
Use the [group phase framework](/content/tags/Groups.md.md.md.md.md.md.md.md.md.md##groups-in-developmental-phases) to implement your governance structure in an evolutionary way, formalizing [Cells](/content/tags/Roles.md#) and other primitives as they are needed, rather than forcing a completed governance design in one go.
...
For each [phase](/content/tags/Groups.md.md.md.md.md##groups-in-developmental-phases) identify clear:
...
However the system is structured, it is important to have feedback mechanisms that can source feedback from all of the different [scales](/content/tags/Groups.md.md.md.md.md.md.md.md##groups-at-different-scales) that the system operates at—[collaboration, coordination, constituency](/content/tags/Groups.md.md.md.md.md.md.md.md.md##groups-at-different-scales) and network scales—and from diverse members of the community operating at its edges.
...
2. **[Constituency Scale](/content/tags/Groups.md.md.md.md.md.md.md.md.md.md##groups-at-different-scales)**: how decisions at the community governance level influences the operational governance
3. **[Coordination Scale](/content/tags/Groups.md.md.md.md.md.md.md.md.md.md.md##groups-at-different-scales)**: how the operational network makes decisions, allocates resources etc
4. **[Collaboration Scale](/content/tags/Groups.md.md.md.md.md.md.md.md.md.md.md.md##groups-at-different-scales)**: how individual [Cells](/content/tags/Roles.md#) make decisions about what work they do and how they do it
...
Effective operational governance is not a fixed structure but an evolving system that grows more sophisticated as your network learns and adapts. By thoughtfully applying the [DAO primitives framework](/content/artifacts/guides/dao-primitives-framework/DAO%2520Primitives%2520Conceptual%2520Framework.md#), organizations can create operational structures that balance autonomy with [coordination](/content/tags/Coordination.md#.md#.md#.md#), enabling small autonomous teams to work together powerfully while maintaining the flexibility to innovate and respond to changing conditions.
