...
- [Implementation-guide-operational-governance](content/artifacts/guides/dao-primitives-framework/dao-primitives-implemention/implementation-guide-operational-governance.md#) (this guide)
...
- [Implementation-guide-multi-stakeholder-governance](content/notes/dao-primitives/implementation/guides/governance/implementation-guide-multi-stakeholder-governance.md#)
- [Implementation-guide-community-governance](content/notes/dao-primitives/implementation/guides/governance/implementation-guide-community-governance.md#)
...
- [[content/tags/daos|DAO]] contributors working to create more effective [[content/tags/coordination|coordination]] systems
...
The [[content/artifacts/guides/dao-primitives-framework/index|DAO primitives framework]] provides 4 fundamental building blocks for creating effective decentralized organizations:

1. **[[content/tags/daos|DAOs]]** - the larger constituency scale community container that the operational governance operates inside
2. **[[content/tags/roles|Cells]]** - the basic operational unit in a DAO - a small autonomous team
3. **[[content/tags/roles|Roles]]** - which contain and manage specific [[content/tags/responsibilities|responsibilities]] and sets of permissions
...
- **Phase** - each DAO, Cell, Role or Task can move through a [[content/tags/groups#Groups in Developmental Phases|group phase lifecycle]]
- **Scale** - different organizational levels from [[content/tags/groups#Groups at Different Scales|collaboration to coordination to constituency]] to network
...
Using the [[content/artifacts/guides/dao-primitives-framework/index|DAO primitives framework]] to create a purpose aligned network of small autonomous teams, there tend to be three facets of governance structure.

1. **[[content/tags/governance#Community Governance|Community Governance]]**: [[content/tags/groups#Groups at Different Scales|constituency scale]] governance that guides and protects the network
2. **[[content/tags/governance#Operational Governance|Operational Governance]]**: [[content/tags/groups#Groups at Different Scales|coordination and collaboration scale]] governance that effectively executes on the purpose and goals of the community governance
3. **[[content/tags/governance#Multi-Stakeholder Governance|Multi-Stakeholder Governance]]**: the mechanism by which the network can connect to and partner with other organizations and networks (network scale)

The operational governance model forms the coordinating backbone of a [[content/tags/daos|DAO]] network, translating community-defined purpose into effective execution through autonomous teams. It operates at the [[content/tags/groups#Groups at Different Scales|coordination and collaboration scales]], creating the organizational infrastructure that enables small autonomous teams to work together coherently while maintaining the flexibility and innovation that comes from decentralized decision-making.
...
2. **[[content/tags/coordination|Coordination]]**: The network of coordinating structures that enable [[content/tags/roles|Cells]] to work together, share resources, develop strategy, and maintain coherence across the operational network while preserving Cell autonomy.
3. **Cell-Level Governance**: Individual autonomous small teams ([[content/tags/roles|Cells]]) that have the freedom to determine how they execute their work, make local decisions, and coordinate directly with other Cells as needed for their specific functions.
...
There are many ways to use the [[content/artifacts/guides/dao-primitives-framework/index|DAO primitives]] to compose a network of operational teams. The particular system you create will reflect the specific needs of the work your community wants to engage in.
...
You may want to or have already created an impact model (or theory of change) to describe the way you want your network to have positive impact on the world. It is not necessary to do this right away, as in the early [[content/tags/groups#Groups in Developmental Phases|phases]] of developing your governance structure these details may still be emerging. But it is recommended to have a clearly articulated impact model as you move into [[content/tags/groups#Groups in Developmental Phases|coordination and organization phases]]. This will ensure that you have a solid coherent and testable foundation to connect your network's purpose to actual measurable change in the world.
...
2. **Decision Scope**: What types of decisions need operational governance?
    ...
    - [[content/tags/coordination|Coordination]] between [[content/tags/roles|cells]]
    - Conflict resolution between teams
3. **Stakeholder Inclusion**: Who needs representation in operational governance?
    - [[content/tags/roles|Cell]] leads/representatives
    - Team members
...
There are many ways that you can use the [[content/artifacts/guides/dao-primitives-framework/index|DAO primitives]] to construct a network of operational teams. The particular system you put together will reflect both the specific realities of the work and the ways in which members want to work together:
...
1. **Highly structured top-down decision-making**
    ...
    - Build hierarchies of [[content/tags/roles|cells]] that answer to cells above them
...
2. **Highly unconstrained networks**
    ...
    - Free-forming of [[content/tags/roles|cells]] that coordinate without constraints from the larger network
...
See [[content/artifacts/patterns/index|patterns]] for different approaches to building operational structures with the DAO Primitives.

#### Activity: Community-Operational Boundary Design

Using the [[content/artifacts/guides/dao-primitives-framework/index|DAO primitives framework]], design a structure that implements a network of operational [[content/tags/roles|Cells]]. It needs to cover four different levels of scale:

1. **Community governance level ([[content/tags/groups#Groups at Different Scales|constituency scale]])**
    ...
    - _See [[content/tags/governance#Community Governance|Community Governance]] pattern and implementation guide_
2. **Cell coordination level ([[content/tags/groups#Groups at Different Scales|coordination scale]])**
    - How the operational network connects with community governance
        - Perhaps via a top-level [[content/tags/roles|Cell]] that takes instruction from community governance
    ...
    - Define the initial structure of [[content/tags/roles|Cells]] needed to instantiate operations
3. **Cell level ([[content/tags/groups#Groups at Different Scales|collaboration scale]])**
    - Define minimum information standards (state) expected of [[content/tags/roles|Cells]]
    - Create templates or archetypal [[content/tags/roles|Cell]] types to standardize new Cells
4. **Partnerships level (network scale)**
    - Design a mechanism for [[content/tags/roles|Cells]] to partner with other organizations and networks
    - _See [[content/tags/governance#Multi-Stakeholder Governance|Multi-Stakeholder Governance]] Implementation Guide_
...
4. **[[content/tags/roles|Roles]] and [[content/tags/responsibilities|Responsibilities]]**: Key functions within the governance system
5. **Resource Allocation**: How governance will manage organizational resources
6. **Boundaries and Constraints**: Limits on governance authority and [[content/tags/roles|Cell]] autonomy
...
2. Set up core [[content/tags/coordination|coordination]] primitives (basic [[content/tags/agreements|agreements]] and protocols)
3. Establish foundational [[content/tags/roles|roles]] and [[content/tags/responsibilities|responsibilities]]
...
Use the concept of [[content/tags/groups#Groups in Developmental Phases|group phase]] to implement your governance structure in an evolutionary way, formalizing [[content/tags/roles|Cells]] and other primitives as they are ready, rather than forcing a completed governance design all at once.

#### Conversation Phase

During this initial [[content/tags/groups#Groups in Developmental Phases|phase]], focus on:
...
As implementation progresses, the [[content/tags/groups#Groups in Developmental Phases|formation phase]] includes:

- Formalizing core [[content/tags/agreements|agreements]], communication and meeting protocols
- Establishing initial [[content/tags/roles|roles]] and [[content/tags/responsibilities|responsibilities]]
...
2. Establish critical [[content/tags/roles|roles]] and select/elect initial occupants
...
In this [[content/tags/groups#Groups in Developmental Phases|phase]], focus on:
...
- Developing [[content/tags/policies|policies]] (e.g., codes of conduct, conflict resolution processes)
...
In the final implementation [[content/tags/groups#Groups in Developmental Phases|phase]], establish:

- Ongoing community engagement/participation in governance
- Ongoing upkeep of documentation and systems
- Ongoing management of governance [[content/tags/roles|roles]] and authorities
- Continued processes for governance feedback and evolution

**Key Activities:**

1. Implement teams, squads, [[content/tags/roles|Cells]] and [[content/tags/roles|roles]] to manage ongoing governance functions
...
4. **[[content/tags/roles|Role]] Descriptions**: Clear documentation of governance [[content/tags/roles|roles]] and [[content/tags/responsibilities|responsibilities]]
5. **Process Maps**: Visual representations of key governance processes
6. **[[content/tags/policies|Policies]]**: Explicit guidelines governing community behavior
...
2. **Tool Selection** Here are some potential tool options for different core operational governance functions: a. **Knowledge repository**
    ...
    b. **[[content/tags/roles|Cell]] state repository**
    
    - A mechanism for containing and updating [[content/tags/roles|Cell]] state
    ...
    - Voting mechanisms ([[content/artifacts/articles/network-evolution/Building DAOs as scalable networks#Community Governance|token-based governance]], [[content/artifacts/articles/governance-for-better-futures/Governance for better futures - Meta-governance#quadratic voting|quadratic voting]], reputation-based, etc.)
3. **Implementation Approach**
    - Start with minimum viable governance tools as required by the [[content/tags/groups#Groups in Developmental Phases|phase]] of development
...
Use the [[content/tags/groups#Groups in Developmental Phases|group phase framework]] to implement your governance structure in an evolutionary way, formalizing [[content/tags/roles|Cells]] and other primitives as they are needed, rather than forcing a completed governance design in one go.
...
For each [[content/tags/groups#Groups in Developmental Phases|phase]] identify clear:
...
However the system is structured, it is important to have feedback mechanisms that can source feedback from all of the different [[content/tags/groups#Groups at Different Scales|scales]] that the system operates at—[[content/tags/groups#Groups at Different Scales|collaboration, coordination, constituency]] and network scales—and from diverse members of the community operating at its edges.
...
- Are [[content/tags/roles|Cells]] able to operate autonomously while maintaining alignment?
...
2. **[[content/tags/groups#Groups at Different Scales|Constituency Scale]]**: how decisions at the community governance level influences the operational governance
3. **[[content/tags/groups#Groups at Different Scales|Coordination Scale]]**: how the operational network makes decisions, allocates resources etc
4. **[[content/tags/groups#Groups at Different Scales|Collaboration Scale]]**: how individual [[content/tags/roles|Cells]] make decisions about what work they do and how they do it
...
Effective operational governance is not a fixed structure but an evolving system that grows more sophisticated as your network learns and adapts. By thoughtfully applying the [[content/artifacts/guides/dao-primitives-framework/index|DAO primitives framework]], organizations can create operational structures that balance autonomy with [[content/tags/coordination|coordination]], enabling small autonomous teams to work together powerfully while maintaining the flexibility to innovate and respond to changing conditions.
