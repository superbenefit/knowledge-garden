...
- [Implementation-guide-multi-stakeholder-governance](/content/artifacts/guides/dao-primitives-framework/dao-primitives-implemention/implementation-guide-multi-stakeholder-governance.md#) (this guide)
...
========
- [Implementation-guide-operational-governance](/content/notes/dao-primitives/implementation/guides/governance/implementation-guide-operational-governance.md#)
...
2. Design a governance structure using the [[/content/artifacts/guides/dao-primitives-framework/index|DAO primitives framework]]
...
- **[[/content/tags/daos|DAOs]] and Web3 Projects**: Looking to implement more balanced stakeholder relationships
...
- **Top Level Cell (TLC)**: The highest operational [[/content/tags/coordination|coordination]] point that interacts with the Stakeholder Group
- **[[/content/tags/roles|Cell]]**: An autonomous team (fewer than 10 people) who collectively define and execute their work
...
- **Cell State**: A formal declaration of a [[/content/tags/roles|Cell's]] purpose, strategy, [[/content/tags/agreements|agreements]], and other properties
...
4. **Progressive [[/content/tags/decentralization|Decentralization]]**: Governance evolves toward greater distribution of power over time
5. **Autonomous [[/content/tags/coordination|Coordination]]**: Small teams self-organize while maintaining network relationships
...
Using the [[/content/artifacts/guides/dao-primitives-framework/index|DAO primitives framework]] to create a purpose aligned network of small autonomous teams, we utilize 3 distinct and interlocking systems of governance:
...
The multi-stakeholder governance model effectively creates a small version (a fractal) of a [[/content/tags/daos|DAO]] within another DAO network. It has the same properties as a larger DAO and attempts to provide the same powerful organizational dynamics, but allows for smaller projects and partnerships to be easily spun up in flexible ways. Creating connections between partners and allowing traditional organizations to gain the benefits of operating in a decentralized web3 enabled context.
...
2. **Operational Governance**: The Top Level Cell (TLC) that interfaces with the stakeholder group and creates and coordinates the [[/content/tags/roles|Cells]], partners and contributors that make up the operational structure.
3. **Cell-Level Governance**: Individual autonomous small teams working on specific [[/content/tags/roles|roles]] and tasks outlined by the TLC or other [[/content/tags/roles|Cells]] in the operational structure
...
You may want to or have already created an impact model (or theory of change) to describe how you want your network to have positive impact on the world. It is not necessary to do this right away, as in the early [[/content/tags/groups#Groups in Developmental Phases|phases]] ([[/content/tags/groups#Groups in Developmental Phases|conversation and formation phases]]) of developing your governance structure these details may still be emerging. But it is recommended to have a clearly articulated impact model as you move into [[/content/tags/groups#Groups in Developmental Phases|coordination and organization phases]]. This will ensure that you have a solid coherent and testable foundation to connect your network's purpose to actual measurable change in the world.
...
1. **Decision Scope**: What types of decisions will be made at which level of governance and with what consultation?
    ...
    - Resource allocation
    - Changes to fundamental [[/content/tags/agreements|agreements]]
    - Conflict resolution
...
**Stakeholder Group [[/content/tags/responsibilities|Responsibilities]]:**
...
**Top Level Cell [[/content/tags/responsibilities|Responsibilities]]:**

- Strategy development
- Operational structure design
- Resource allocation within approved budgets
- Prioritization and [[/content/tags/coordination|coordination]]

**Cell-Level [[/content/tags/responsibilities|Responsibilities]]:**

- Task execution approaches
- Internal [[/content/tags/roles|Cell]] organization
...
3. Create [[/content/tags/roles|roles]] (facilitator, liaison to TLC, etc.)
4. Document meeting cadence and communication channels
5. Define funding [[/content/tags/agreements|agreements]] - who will contribute funding and what rights will they have?
...
3. Create communication protocols with SHG and other [[/content/tags/roles|cells]]
...
1. Set up optimistic governance [[/content/tags/agreements|agreements]] and processes
...
2. Set up [[/content/tags/agreements|agreements]] and processes for treasury management and token transfers

#### Cell Network Design

1. Define [[/content/tags/roles|cell]] formation process
2. Establish [[/content/tags/roles|cell]] [[/content/tags/coordination|coordination]] mechanisms
...
3. **[[/content/tags/roles|Roles]] and [[/content/tags/responsibilities|Responsibilities]]**: Key functions within the governance system
...
#### Phase 1: [[/content/tags/groups#Groups in Developmental Phases|Conversation]]
...
- Document preliminary [[/content/tags/agreements|agreements]]
- Establish communication channels

#### Phase 2: [[/content/tags/groups#Groups in Developmental Phases|Formation]]

- Formalize Stakeholder Group
    - Define purpose and high-level goals
    - Create initial proposal process
    - Establish Top Level Cell - core [[/content/tags/agreements|agreements]] between SHG and TLC
    - Set up SHG treasury management and processes

#### Phase 3: [[/content/tags/groups#Groups in Developmental Phases|Organization]]

- Formalize Top Level Cell
    - TLC develops strategy
    - Implements operational structure - creates first operational [[/content/tags/roles|Cells]] in the network
    - Establishes treasury management and resource allocation processes
    - Formalize documentation and processes in Cell state
    - Establish communication channels and other [[/content/tags/coordination|coordination]] tooling

#### Phase 4: [[/content/tags/groups#Groups in Developmental Phases|Coordination]]
...
If you are setting up multi-stakeholder governance inside an existing [[/content/tags/daos|DAO]] or other network, there will already be established tools and practices used by the community. In this case it would likely make sense to utilize these.
...
2. **Tool Selection** Here are some potential tool options for different core governance functions: a. **Knowledge repository**
    ...
    - Communication will happen at different [[/content/tags/groups#Groups at Different Scales|scales]]
    ...
    - Voting mechanisms ([[/content/artifacts/articles/network-evolution/Building DAOs as scalable networks#Community Governance|token-based]], [[/content/artifacts/articles/governance-for-better-futures/Governance for better futures - Meta-governance#quadratic voting|quadratic]], reputation-based, etc.)
...
Use the [[/content/tags/groups#Groups in Developmental Phases|group phase framework]] to implement your governance structure in an evolutionary way, formalizing the stakeholder group, top level cell and then [[/content/tags/roles|Cells]] and other primitives as they are needed, rather than forcing a completed governance design in one go.

1. [[/content/tags/groups#Groups in Developmental Phases|Conversation Phase]]
2. [[/content/tags/groups#Groups in Developmental Phases|Formation Phase]]
3. [[/content/tags/groups#Groups in Developmental Phases|Organization Phase]]
4. [[/content/tags/groups#Groups in Developmental Phases|Coordination Phase]]
...
This adaptation needs to occur at all levels in the system. Evolution of the stakeholder governance and the operational governance structures as well as individual [[/content/tags/roles|Cells]] evolving their governance practices.
...
The partnership model of multi-stakeholder governance offers a powerful framework for balancing stakeholder stewardship with operational autonomy. By implementing this model using the [[/content/artifacts/guides/dao-primitives-framework/index|DAO primitives]] approach, you can create governance that is both robust and adaptable.
