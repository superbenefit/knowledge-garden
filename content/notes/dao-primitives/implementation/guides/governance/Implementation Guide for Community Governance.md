...
We have identified and experimented with using the DAO primitives framework to produce governance systems based on 3 interlocking governance structures: [Community Governance](/content/tags/Decentralized%2520Governance.md#.md#), [Operational Governance](/content/tags/Decentralized%2520Governance.md#.md#.md#) and [Multi-Stakeholder Governance](multi-stakeholder-governance.md#).
...
- [Implementation-guide-community-governance](/content/artifacts/guides/dao-primitives-framework/dao-primitives-implemention/Implementation%2520Guide%2520for%2520Community%2520Governance.md#) (this guide)
========
...
- [Implementation-guide-community-governance](Implementation%2520Guide%2520for%2520Community%2520Governance.md#) (this guide)
...
In this DAO Primitives context, Community governance exists as part of a three-layers governance model that occur at three different [layers of scale](/content/tags/Groups.md.md##groups-at-different-scales):
...
- **[Coordination](/content/tags/Coordination.md#) at Scale**: How to make collective decisions as networks grow beyond face-to-face and small group interaction scales
...
3. **[Roles](/content/tags/Roles.md#.md#)** - which contain and manage specific responsibilities and sets of permissions
...
- **Scale** - different organizational levels from [collaboration to coordination to constituency](/content/tags/Groups.md.md.md##groups-at-different-scales) to network
...
You may want to or have already created an impact model (or theory of change) to describe the way you want your network to have positive impact on the world. It is not necessary to do this right away, as in the early phases ([conversation and formation phases](/content/tags/Groups.md.md##groups-in-developmental-phases)) of developing a community governance structure these details may still be emerging. But it is recommended to have a clearly articulated impact model as you move into coordination and organization phases. This will ensure that you have a solid coherent and testable foundation to connect your network's purpose to actual measurable change in the world.
...
2. **Reputation-Based Governance**
    ...
    - Key Primitives: [Attestations](/content/tags/Attestations.md#), contribution tracking, reputation algorithms
...
4. **Council Governance**
    - Description: Selected group with defined [responsibilities](/content/tags/Responsibilities.md#) and constraints
...
5. **Sortition-Based Governance**
    - Description: Random selection of participants for decision-making [roles](/content/tags/Roles.md#.md#.md#)
...
1. **Selected Patterns**: Which governance patterns you've chosen to incorporate a. You can select defined patterns from the SuperBenefit Knowledge Garden here [patterns](/content/artifacts/patterns/Pattern%2520Library.md#)
...
2. Set up core [coordination](/content/tags/Coordination.md#.md#) primitives (basic [agreements](/content/tags/Agreements.md#) and protocols)
3. Establish foundational [roles](/content/tags/Roles.md#.md#.md#) and [responsibilities](/content/tags/Responsibilities.md#)
...
During this initial [phase](/content/tags/Groups.md.md.md##groups-in-developmental-phases), focus on:
...
- Establishing initial [roles](/content/tags/Roles.md#.md#.md#) and [responsibilities](/content/tags/Responsibilities.md#)
...
2. Establish critical [roles](/content/tags/Roles.md#.md#.md#) and select/elect initial occupants
...
- Developing [policies](/content/tags/Policies.md#) e.g codes of conduct, conflict resolution processes etc
...
- Ongoing management of governance [roles](/content/tags/Roles.md#.md#.md#) and authorities
- Continued processes for governance feedback and evolution

**Key Activities:**

1. Implement teams, squads, [Cells](/content/tags/Roles.md#) and [roles](/content/tags/Roles.md#.md#.md#) etc to manage ongoing community governance functions
...
3. **[Role](/content/tags/Roles.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#) Descriptions**: Clear documentation of governance [roles](/content/tags/Roles.md#.md#.md#) and [responsibilities](/content/tags/Responsibilities.md#)
4. **Process Maps**: Visual representations of key governance processes
5. **[Policies](/content/tags/Policies.md#.md#)**: Explicit guidelines governing community behavior
...
See [dao-state](/content/notes/dao-primitives/implementation/patterns/dao-patterns/DAO%2520State.md#) for details on implementing state documentation for a community governance structure
...
Implementing governance requires creating specific structures that enable [coordination](/content/tags/Coordination.md#.md#) and decision-making.
...
3. **Working Groups**
    ...
    - Documented [coordination](/content/tags/Coordination.md#.md#) with broader governance
    - Appropriate autonomy balanced with accountability
    - DAO primitives framework uses [Cells](/content/tags/Roles.md#) as a working group primitive
4. **Advisory Councils**
...
1. [Conversation Phase](/content/tags/Groups.md.md.md.md##groups-in-developmental-phases)
2. [Formation Phase](/content/tags/Groups.md.md.md.md.md##groups-in-developmental-phases)
3. [Organisation Phase](/content/tags/Groups.md.md.md.md.md.md##groups-in-developmental-phases)
4. [Coordination Phase](/content/tags/Groups.md.md.md.md.md.md.md##groups-in-developmental-phases)
