...
*   **[[content/notes/rpp/rpp-working-docs/token-based-governance|token-based-governance]]:** This pattern often relies on a hybrid model, using tokens for off-chain voting power on platforms like Snapshot and for on-chain voting power in formal protocols.
