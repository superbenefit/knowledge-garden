...
*   **[[/content/notes/rpp/rpp-working-docs/token-based-governance|token-based-governance]]**: Quadratic Voting is often positioned as a direct alternative or remedy to the plutocratic tendencies inherent in the "one token, one vote" model.
