...
*   **[on-chain-vs.-off-chain-governance](/content/notes/rpp/rpp-working-docs/On-Chain%2520vs.%2520Off-Chain%2520Governance.md#):** This pattern provides the technical framework for how token votes are actually conducted and executed.
...
*   **[quadratic-voting](/content/notes/rpp/rpp-working-docs/Quadratic%2520Voting.md#):** A contrasting pattern that aims to solve the plutocracy problem by making an individual's subsequent votes more "expensive" than their first, thus promoting a more egalitarian distribution of power.