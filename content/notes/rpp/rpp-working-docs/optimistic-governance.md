...
- **[[./on-chain-vs.-off-chain-governance|on-chain-vs.-off-chain-governance]]:** Optimistic Governance is a powerful pattern that bridges the off-chain and on-chain worlds. It allows the speed of off-chain decision-making while retaining the security of an on-chain veto mechanism.
