...
*   **[token-based-governance](/content/notes/rpp/rpp-working-docs/Token-Based%2520Governance.md#)**: Quadratic Voting is often positioned as a direct alternative or remedy to the plutocratic tendencies inherent in the "one token, one vote" model.
