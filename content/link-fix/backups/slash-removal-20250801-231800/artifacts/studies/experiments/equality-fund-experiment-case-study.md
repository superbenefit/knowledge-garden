...
This case study documents progress through July 2025 in an ongoing experiment exploring [Web3](/tags/web3.md) technologies for feminist grant-making. Equality Fund partnered with Women Win and SuperBenefit through the Reimagining Power Project to test whether [blockchain](/tags/blockchain.md) could reduce transaction costs and increase accessibility for organizations in politically restricted contexts.
