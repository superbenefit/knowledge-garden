...
In this DAO Primitives context, Community governance exists as part of a three-layers governance model that occur at three different [](tags/groups.md#Groups at Different Scales|layers of scale):
...
You may want to or have already created an impact model (or theory of change) to describe the way you want your network to have positive impact on the world. It is not necessary to do this right away, as in the early phases ([](tags/groups.md#Groups in Developmental Phases|conversation and formation phases)) of developing a community governance structure these details may still be emerging. But it is recommended to have a clearly articulated impact model as you move into coordination and organization phases. This will ensure that you have a solid coherent and testable foundation to connect your network's purpose to actual measurable change in the world.
...
5. **Technical Considerations**: What technical factors shape the implementation options?
    - [](artifacts/articles/network-evolution/Building DAOs as scalable networks.md#Community Governance|On-chain vs. off-chain) processes
    - Available tooling
...
1. **[](artifacts/articles/network-evolution/Building DAOs as scalable networks.md#Community Governance|Token-based governance)**
...
7. **Quadratic Governance**
    ...
    - Key Primitives: [](artifacts/articles/governance-for-better-futures/Governance for better futures - Meta-governance.md#quadratic voting|quadratic voting), funding mechanisms, identity verification
...
1. **[](artifacts/articles/network-evolution/Building DAOs as scalable networks.md#Community Governance|On-chain vs. off-chain governance)**
...
3. [](tags/groups.md#Groups in Developmental Phases|Organisation Phase)
