...
Before creating a new library entry, evaluate whether the resource is a good fit using the link-evaluation-workflow prompt.
...
Once a resource has been approved for inclusion, use the link-creation-workflow prompt to create a new entry following our standardized format.
