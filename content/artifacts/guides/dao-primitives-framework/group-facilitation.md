...
Review the [[./index|dao-primitives framework]] along with [[../../../../patterns|patterns]] and [[../../../../case-studies|case-studies]] to guide the group toward settling on a governance approach that matches their outlined requirements rather than defaulting to popular or familiar options that may not fit their context.
...
Follow the [[./group-phase/index|group-phase]] model to ensure implementation steps are appropriate for each phase of the group's evolution:
...
- [[./index|Complete Framework Overview]]
...
- Pattern Library for specific solutions -  [[../../patterns/index|patterns]]
