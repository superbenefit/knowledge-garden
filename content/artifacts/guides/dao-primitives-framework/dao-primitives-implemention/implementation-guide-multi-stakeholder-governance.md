...
- **Cell State**: A formal declaration of a [Cell's](../../../../tags/roles.md#.md#) purpose, strategy, [agreements](../../../../tags/agreements.md#), and other properties
...
5. **Autonomous [Coordination](../../../../tags/coordination.md#.md#)**: Small teams self-organize while maintaining network relationships
...
2. **[Cells](../../../../tags/roles.md#.md#.md#)** - the basic operational unit in a DAO - a small autonomous team
3. **[Roles](../../../../tags/roles.md#.md#.md#.md#)** - which contain and manage specific [responsibilities](../../../../tags/responsibilities.md#) and sets of permissions
...
The multi-stakeholder governance model effectively creates a small version (a fractal) of a [DAO](../../../../tags/daos.md#.md#.md#) within another DAO network. It has the same properties as a larger DAO and attempts to provide the same powerful organizational dynamics, but allows for smaller projects and partnerships to be easily spun up in flexible ways. Creating connections between partners and allowing traditional organizations to gain the benefits of operating in a decentralized web3 enabled context.
...
2. **Operational Governance**: The Top Level Cell (TLC) that interfaces with the stakeholder group and creates and coordinates the [Cells](../../../../tags/roles.md#.md#.md#), partners and contributors that make up the operational structure.
3. **Cell-Level Governance**: Individual autonomous small teams working on specific [roles](../../../../tags/roles.md#.md#.md#.md#.md#.md#) and tasks outlined by the TLC or other [Cells](../../../../tags/roles.md#.md#.md#) in the operational structure
...
You may want to or have already created an impact model (or theory of change) to describe how you want your network to have positive impact on the world. It is not necessary to do this right away, as in the early [phases](../../../../tags/groups.md.md##groups-in-developmental-phases) ([conversation and formation phases](../../../../tags/groups.md.md.md##groups-in-developmental-phases)) of developing your governance structure these details may still be emerging. But it is recommended to have a clearly articulated impact model as you move into [coordination and organization phases](../../../../tags/groups.md.md.md.md##groups-in-developmental-phases). This will ensure that you have a solid coherent and testable foundation to connect your network's purpose to actual measurable change in the world.
...
1. **Decision Scope**: What types of decisions will be made at which level of governance and with what consultation?
   ...
   - Resource allocation
   - Changes to fundamental [agreements](../../../../tags/agreements.md#.md#)
   - Conflict resolution
...
**Stakeholder Group [Responsibilities](../../../../tags/responsibilities.md#.md#):**
...
**Top Level Cell [Responsibilities](../../../../tags/responsibilities.md#.md#):**
...
**Cell-Level [Responsibilities](../../../../tags/responsibilities.md#.md#):**
...
3. Create [roles](../../../../tags/roles.md#.md#.md#.md#.md#.md#) (facilitator, liaison to TLC, etc.)
4. Document meeting cadence and communication channels
5. Define funding [agreements](../../../../tags/agreements.md#.md#) - who will contribute funding and what rights will they have?
...
3. Create communication protocols with SHG and other [cells](../../../../tags/roles.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#)
...
1. Set up optimistic governance [agreements](../../../../tags/agreements.md#.md#) and processes
...
2. Set up [agreements](../../../../tags/agreements.md#.md#) and processes for treasury management and token transfers

#### Cell Network Design

1. Define [cell](../../../../tags/roles.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#) formation process
2. Establish [cell](../../../../tags/roles.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#.md#) [coordination](../../../../tags/coordination.md#) mechanisms
...
3. **[Roles](../../../../tags/roles.md#.md#.md#.md#) and [Responsibilities](../../../../tags/responsibilities.md#.md#)**: Key functions within the governance system
...
#### Phase 1: [Conversation](../../../../tags/groups.md.md.md.md.md##groups-in-developmental-phases)
...
- Document preliminary [agreements](../../../../tags/agreements.md#.md#)
- Establish communication channels

#### Phase 2: [Formation](../../../../tags/groups.md.md.md.md.md.md##groups-in-developmental-phases)

- Formalize Stakeholder Group
  - Define purpose and high-level goals
  - Create initial proposal process
  - Establish Top Level Cell - core [agreements](../../../../tags/agreements.md#.md#) between SHG and TLC
  - Set up SHG treasury management and processes

#### Phase 3: [Organization](../../../../tags/groups.md.md.md.md.md.md.md##groups-in-developmental-phases)

- Formalize Top Level Cell
  - TLC develops strategy
  - Implements operational structure - creates first operational [Cells](../../../../tags/roles.md#.md#.md#) in the network
...
#### Phase 4: [Coordination](../../../../tags/groups.md.md.md.md.md.md.md.md##groups-in-developmental-phases)
...
If you are setting up multi-stakeholder governance inside an existing [DAO](../../../../tags/daos.md#.md#.md#) or other network, there will already be established tools and practices used by the community. In this case it would likely make sense to utilize these.
...
2. **Tool Selection** Here are some potential tool options for different core governance functions: a. **Knowledge repository**
   ...
   - Communication will happen at different [scales](../../../../tags/groups.md.md.md.md##groups-at-different-scales)
...
3. **Implementation Approach**
   - Start with minimum viable governance tools as required by the [phase](../../../../tags/groups.md.md.md.md.md.md.md.md.md##groups-in-developmental-phases) of development
...
Use the [group phase framework](../../../../tags/groups.md.md.md.md.md.md.md.md.md.md##groups-in-developmental-phases) to implement your governance structure in an evolutionary way, formalizing the stakeholder group, top level cell and then [Cells](../../../../tags/roles.md#.md#.md#) and other primitives as they are needed, rather than forcing a completed governance design in one go.

1. [Conversation Phase](../../../../tags/groups.md.md.md.md.md.md.md.md.md.md.md##groups-in-developmental-phases)
2. [Formation Phase](../../../../tags/groups.md.md.md.md.md.md.md.md.md.md.md.md##groups-in-developmental-phases)
3. [Organization Phase](../../../../tags/groups.md.md.md.md.md.md.md.md.md.md.md.md.md##groups-in-developmental-phases)
4. [Coordination Phase](../../../../tags/groups.md.md.md.md.md.md.md.md.md.md.md.md.md.md##groups-in-developmental-phases)
...
For each [phase](../../../../tags/groups.md.md.md.md.md.md.md.md.md##groups-in-developmental-phases) identify clear:
...
However the system is structured, it is important to have feedback mechanisms that can source feedback from all of the different [scales](../../../../tags/groups.md.md.md.md##groups-at-different-scales) that the system operates at—[collaboration, coordination, constituency](../../../../tags/groups.md.md.md.md.md.md##groups-at-different-scales) and network scales—and from diverse members of the community operating at its edges.
...
This adaptation needs to occur at all levels in the system. Evolution of the stakeholder governance and the operational governance structures as well as individual [Cells](../../../../tags/roles.md#.md#.md#) evolving their governance practices.
...
The partnership model of multi-stakeholder governance offers a powerful framework for balancing stakeholder stewardship with operational autonomy. By implementing this model using the [DAO primitives](../index.md#.md#.md#.md#.md#) approach, you can create governance that is both robust and adaptable.
