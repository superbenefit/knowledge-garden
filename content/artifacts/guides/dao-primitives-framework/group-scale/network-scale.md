...
Network scale spans and leverages the three other group scales ([[./collaboration-scale|collaboration-scale]], [[./coordination-scale|coordination-scale]], and [[./constituency-scale|constituency-scale]] scales).
...
- **Multi-Scale:** The network is operationalized through interdependent entities that operate at different [[./index|group-scales]], in order to most effectively deliver on the goals of the network.
