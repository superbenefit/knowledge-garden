...
2. **Context Richness**: Members develop shared mental models and tacit knowledge through ongoing presence and interaction, reducing the need for explicit documentation of all [decisions](content/tags/decisions.md) and rationales.
...
- **Insularity:** The tendency for groups to become overly separated and self-serving, no longer a genuine participant in the [network's](content/tags/networks.md) goals.
...
1. **Enabling Constraints**: Group ways-of-working that emphasize self-management, shared [decision-making](content/tags/decisions.md), and collective sense-making. Enabling constraints tend to take the form of group-level [agreements](content/tags/agreements.md) about how the group will meet, work, and make decisions.
2. **Formal Processes**: These are more structured processes often used to manage things that carry significant risk, such as [treasury](content/tags/treasury.md) management [decisions](content/tags/decisions.md), or other major decisions like making changes to the core [governance](content/tags/governance.md) of the group.
...
- Effective processes for [decision-making](content/tags/decisions.md) and conflict resolution.
