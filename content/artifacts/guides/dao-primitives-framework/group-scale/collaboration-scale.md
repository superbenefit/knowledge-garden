...
1. **Communication Density**: With fewer communication pathways than larger groups, information flows rapidly and with minimal distortion, enabling quick sense-making and [decision](content/tags/decisions.md#) execution.
2. **Context Richness**: Members develop shared mental models and tacit knowledge through ongoing presence and interaction, reducing the need for explicit documentation of all [decisions](content/tags/decisions.md#.md#) and rationales.
...
1. **Enabling Constraints**: Group ways-of-working that emphasize self-management, shared [decision-making](content/tags/decisions.md#.md#.md#), and collective sense-making. Enabling constraints tend to take the form of group-level [agreements](content/tags/agreements.md#) about how the group will meet, work, and make decisions.
2. **Formal Processes**: These are more structured processes often used to manage things that carry significant risk, such as [treasury](content/tags/treasury.md#) management [decisions](content/tags/decisions.md#.md#), or other major decisions like making changes to the core [governance](content/tags/governance.md#) of the group.
...
- [artifacts/patterns/cell](content/artifacts/patterns/cell.md#) 
- [artifacts/patterns/decider-protocol](content/artifacts/patterns/decider-protocol.md#)
- [cells](cells.md#)
...
- Effective processes for [decision-making](content/tags/decisions.md#.md#.md#) and conflict resolution.
