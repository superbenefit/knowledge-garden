...
Unlike the [collaboration-scale](./collaboration-scale.md) and [coordination-scale](./coordination-scale.md) scales, which focus on smaller, more tightly coupled [groups](../../../../tags/groups.md) and sets of groups, Constituency Scale emphasizes participation, representation, and collective [decision-making](../../../../tags/decisions.md) across a wider [community](../../../../tags/community.md). This can range into the millions for a democratic nation. But can also be relatively small numbers, for example a small DAO [network](../../../../tags/networks.md).
...
However, there is a necessary trade-off between scale and the complexity of decisions that it can handle. [Collaboration](./collaboration-scale.md) scale can handle complexity, nuance, tension, etc., [coordination-scale](./coordination-scale.md) scale is more constrained and only able to make more formal decisions (usually that have bubbled up as options from collaboration scale groups). Constituency scale is more constrained still. At large numbers, there is little scope for complex [decision-making](../../../../tags/decisions.md) and usually simple voting mechanisms are used.
...
- **Wrapping Smaller Scales**: Usually constituency scale [governance](../../../../tags/governance.md) will wrap smaller scale operational structures. For example, it will act as the [community](../../../../tags/community.md) governance wrapper that will support [coordination-scale](./coordination-scale.md) and [collaboration-scale](./collaboration-scale.md) scale operational groups.
