...
**All in for Sport**: The DAO primitives framework has been applied to design the AIFS [governance](../../../../tags/governance.md) model and partnership with SuperBenefit. More can be read about this example here: [all-in-for-sport](../../../../../all-in-for-sport.md).

**RPP [Governance](../../../../tags/governance.md)**: This project is a good example of how a larger DAO structure (SuperBenefit) can support multi-stakeholder partnerships within its broad [community](../../../../tags/community.md) governance umbrella. This shows how complex governance and operations can be made simple and effective while maintaining appropriate levels of high-level governance. See [rpp-governance-case-study](../../../studies/projects/rpp-governance-case-study.md)
