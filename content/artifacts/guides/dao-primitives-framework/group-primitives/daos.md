...
**[Governance](../../../../tags/governance.md) [Primitives](../../../../tags/primitives.md)**: In the DAO Primitives Framework, DAOs utilize the other 3 [group-primitives](./index.md) to implement their governance and operational design:
...
**All in for Sport**: The DAO primitives framework has been applied to design the AIFS [governance](../../../../tags/governance.md) model and partnership with SuperBenefit. More can be read about this example here: all-in-for-sport.

**RPP [Governance](../../../../tags/governance.md)**: This project is a good example of how a larger DAO structure (SuperBenefit) can support multi-stakeholder partnerships within its broad [community](../../../../tags/community.md) governance umbrella. This shows how complex governance and operations can be made simple and effective while maintaining appropriate levels of high-level governance. See rpp-governance-design-study
