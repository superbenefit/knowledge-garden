...
When the Coordination phase is complete, a group may either evolve into a [governance](../../../../tags/governance.md) or operational structure or enter a [completion phase](./completion-phase.md#) as its [purpose](../../../../tags/purpose.md) is fulfilled.
...
- **Knowledge Sharing:** Documenting and sharing learnings, tools, and approaches that could benefit others in the [network](../../../../tags/networks.md). Including consistently updating and sharing its [group state](../group-state.md#) documentation.
