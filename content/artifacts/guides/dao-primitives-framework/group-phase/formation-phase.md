...
- **Purpose Definition:** The group works from the clear, specific purpose statement that emerged in the [[content/artifacts/guides/dao-primitives-framework/group-phase/conversation-phase|conversation-phase]] phase. This defines its reason for existence and intended contribution to the broader network.
- **Structured Decision-Making:** Simple but formal [[content/tags/decisions|decision]] processes begin to replace purely informal consensus, enabling clearer accountability and execution.
...
- **Resource Planning:** Initial budgets, timelines, and [[content/tags/resources|resource]] needs are identified and documented to support formal proposals for funding or support.
...
- **Resource Mapping:** Identifying needed skills, knowledge, and [[content/tags/resources|resources]] for successful execution.
- **Boundary Definition:** Clarifying what is and isn't within the group's scope and authority.
- **Integration Planning:** Establishing how the group will connect and [[content/tags/coordination|coordinate]] with the broader [[content/tags/networks|network]] or [[content/tags/community|community]].
- **[[content/tags/governance|Governance]] & Operational Design:** Designing the governance and operational structure that will be implemented in the [[content/artifacts/guides/dao-primitives-framework/group-phase/organization-phase|organization-phase]] phase.
- **Proposal Development:** Creating formal proposals to seek [[content/tags/community|community]] endorsement, funding, or permission when needed to formally instantiate the group.
- **Initial State Documentation:** Documenting the group's proposed purpose, practices, and plans in a [[content/artifacts/guides/dao-primitives-framework/group-state|group-state]] document. This outlines vision and practical implementation of the group.
...
- Basic [[content/tags/decisions|decision-making]] processes are being consistently followed.
...
- Initial community support and [[content/tags/resources|resources]] have been secured via a proposal or similar.
...
- Initial [[content/tags/resources|resource]] needs and [[content/tags/treasury|treasury]] management approach
...
Formation often requires creating one or more proposals to secure support, [[content/tags/resources|resources]], or formal recognition from the broader [[content/tags/community|community]] or governance system. Effective proposals typically include:
...
- **Resource Access:** Initial [[content/tags/resources|resources]] needed for execution have been secured or identified.
...
- **Community Proposal:** A clear, compelling proposal to the [[content/tags/community|community]] or existing governance structure has been created and is ready to present.
