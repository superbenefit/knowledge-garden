...
The Formation Phase represents the critical transition from open exploration to structured commitment within decentralized networks. Following the ideation and relationship-building of the [Conversation Phase](./conversation-phase.md#), groups in Formation begin establishing clear boundaries, formalizing [agreements](../../../../tags/agreements.md#), and designing the structure needed for coordinated action. This phase transforms emerging potential into concrete design, creating the foundation for functional structure to be implemented.
...
When the formation phase is complete, a group is ready to move on to the [organization phase](./organization-phase.md#).

---

## Key Characteristics

- **Purpose Definition:** The group works from the clear, specific purpose statement that emerged in the [conversation-phase](./conversation-phase.md#.md#) phase. This defines its reason for existence and intended contribution to the broader network.
...
- **Lightweight Documentation:** The group develops basic documentation of its purpose, practices, and progress through an initial [cell state](../../../patterns/cell-state.md#) or nucleus document.
- **Resource Planning:** Initial budgets, timelines, and [resource](../../../../tags/resources.md#.md#) needs are identified and documented to support formal proposals for funding or support.
...
- **[Governance](../../../../tags/governance.md#) & Operational Design:** Designing the governance and operational structure that will be implemented in the [organization-phase](./organization-phase.md#.md#) phase.
- **Proposal Development:** Creating formal proposals to seek [community](../../../../tags/community.md#.md#) endorsement, funding, or permission when needed to formally instantiate the group.
- **Initial State Documentation:** Documenting the group's proposed purpose, practices, and plans in a [group-state](../group-state.md#) document. This outlines vision and practical implementation of the group.
...
A formation phase group may be ready to evolve to a more structured [organization phase](./organization-phase.md#) when:
...
- Basic [decision-making](../../../../tags/decisions.md#.md#) processes are being consistently followed.
...
- The group's [group state](../group-state.md#.md#) document is sufficiently developed to outline the structure to be implemented in the organization phase.
...
Creating a lightweight but clear [group state](../group-state.md#.md#) document is a critical practice during the Formation Phase.
...
- Initial [resource](../../../../tags/resources.md#.md#) needs and [treasury](../../../../tags/treasury.md#) management approach
...
Formation often requires creating one or more proposals to secure support, [resources](../../../../tags/resources.md#), or formal recognition from the broader [community](../../../../tags/community.md#.md#) or governance system. Effective proposals typically include:
...
- **Group Facilitation:** Accessing governance facilitation support can assist with helping the group to get to agreement on exactly how they want to define the group's [group state](../group-state.md#.md#) and which [governance](../../../../tags/governance.md#.md#.md#) [primitives](../../../../tags/primitives.md#) and [practices](../../../../tags/practices.md#) the group wants to adopt.
...
- **Community Proposal:** A clear, compelling proposal to the [community](../../../../tags/community.md#.md#) or existing governance structure has been created and is ready to present.
