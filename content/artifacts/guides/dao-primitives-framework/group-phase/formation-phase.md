...
- **Purpose Definition:** The group works from the clear, specific purpose statement that emerged in the [conversation-phase](content/artifacts/guides/dao-primitives-framework/group-phase/conversation-phase.md) phase. This defines its reason for existence and intended contribution to the broader network.
...
- **Resource Planning:** Initial budgets, timelines, and [resource](content/tags/resources.md) needs are identified and documented to support formal proposals for funding or support.
...
- **[Governance](content/tags/governance.md) & Operational Design:** Designing the governance and operational structure that will be implemented in the [organization-phase](content/artifacts/guides/dao-primitives-framework/group-phase/organization-phase.md) phase.
- **Proposal Development:** Creating formal proposals to seek [community](content/tags/community.md) endorsement, funding, or permission when needed to formally instantiate the group.
...
- Basic [decision-making](content/tags/decisions.md) processes are being consistently followed.
...
- The group's [group state](content/artifacts/guides/dao-primitives-framework/group-state.md#) document is sufficiently developed to outline the structure to be implemented in the organization phase.
...
Creating a lightweight but clear [group state](content/artifacts/guides/dao-primitives-framework/group-state.md#) document is a critical practice during the Formation Phase.
...
- Initial [resource](content/tags/resources.md) needs and [treasury](content/tags/treasury.md) management approach
...
Formation often requires creating one or more proposals to secure support, [resources](content/tags/resources.md), or formal recognition from the broader [community](content/tags/community.md) or governance system. Effective proposals typically include:
...
- **Community Proposal:** A clear, compelling proposal to the [community](content/tags/community.md) or existing governance structure has been created and is ready to present.
