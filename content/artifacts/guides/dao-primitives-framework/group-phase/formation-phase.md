...
The Formation Phase represents the critical transition from open exploration to structured commitment within decentralized networks. Following the ideation and relationship-building of the [Conversation Phase](./conversation-phase.md#), groups in Formation begin establishing clear boundaries, formalizing [[../../../../tags/agreements|agreements]], and designing the structure needed for coordinated action. This phase transforms emerging potential into concrete design, creating the foundation for functional structure to be implemented.
...
- **Purpose Definition:** The group works from the clear, specific purpose statement that emerged in the [[./conversation-phase|conversation-phase]] phase. This defines its reason for existence and intended contribution to the broader network.
...
- **[[../../../../tags/governance|Governance]] & Operational Design:** Designing the governance and operational structure that will be implemented in the [[./organization-phase|organization-phase]] phase.
...
- **Initial State Documentation:** Documenting the group's proposed purpose, practices, and plans in a [[../group-state|group-state]] document. This outlines vision and practical implementation of the group.
...
- **Group Facilitation:** Accessing governance facilitation support can assist with helping the group to get to agreement on exactly how they want to define the group's [group state](../group-state.md#) and which [[../../../../tags/governance|governance]] [[../../../../tags/primitives|primitives]] and [[../../../../tags/practices|practices]] the group wants to adopt.
