...
- **Purpose Definition:** The group works from the clear, specific purpose statement that emerged in the [conversation-phase](./conversation-phase.md) phase. This defines its reason for existence and intended contribution to the broader network.
...
- **[Governance](../../../../tags/governance.md) & Operational Design:** Designing the governance and operational structure that will be implemented in the [organization-phase](./organization-phase.md) phase.
...
- The group's [group state](../group-state.md#) document is sufficiently developed to outline the structure to be implemented in the organization phase.
...
Creating a lightweight but clear [group state](../group-state.md#) document is a critical practice during the Formation Phase.
...
- **Group Facilitation:** Accessing governance facilitation support can assist with helping the group to get to agreement on exactly how they want to define the group's [group state](../group-state.md#) and which [governance](../../../../tags/governance.md) [primitives](../../../../tags/primitives.md) and [practices](../../../../tags/practices.md) the group wants to adopt.
