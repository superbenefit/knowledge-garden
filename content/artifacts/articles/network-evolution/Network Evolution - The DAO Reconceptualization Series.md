...
"DAOs: From fractal primitives to network scale" introduces the concept of DAOs as networks of connected "cells" - autonomous teams that maintain independence while coordinating with a broader network. This approach has connections to the lexicon's discussions of [cells](cells.md#) and how [groups](/content/tags/Groups.md#) might function at different scales.
...
This approach has connections to the lexicon's exploration of [governance](/content/tags/Decentralized%2520Governance.md#) at different scales and the balance between [coordination](/content/tags/Coordination.md#) and autonomy.
...
These articles connect to several ongoing discussions within the SuperBenefit knowledge base, including the [DAO Primitives Project](/content/artifacts/guides/dao-primitives-framework/DAO%2520Primitives%2520Conceptual%2520Framework.md#) and various governance explorations documented in the [Governance for better futures](/content/artifacts/articles/governance-for-better-futures/Exploring%2520governance%2520for%2520better%2520futures.md#) series.
