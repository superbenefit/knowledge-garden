...
"DAOs: From fractal primitives to network scale" introduces the concept of DAOs as networks of connected "cells" - autonomous teams that maintain independence while coordinating with a broader network. This approach has connections to the lexicon's discussions of [cells](cells.md#) and how [groups](../../../tags/groups.md#) might function at different scales.
...
These articles connect to several ongoing discussions within the SuperBenefit knowledge base, including the [DAO Primitives Project](../../guides/dao-primitives-framework/index.md#) and various governance explorations documented in the [Governance for better futures](../governance-for-better-futures/index.md#) series.
