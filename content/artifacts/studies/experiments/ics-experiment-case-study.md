...
The experiment successfully established operational governance systems using token-based governance, multistakeholder governance patterns, and [DAOs](content/tags/daos.md) structure, all managed through [roles](content/tags/roles.md) implementation with Hats Protocol. Four core team members actively use these systems. ICS launched London's first local-nodes implementation as a Green Pill Network chapter and achieved top 10% ranking in Gitcoin Grants Round 23.
