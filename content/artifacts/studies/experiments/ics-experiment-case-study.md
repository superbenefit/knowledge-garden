...
*ICS experiments with [[content/tags/decentralization|decentralized]] [[content/tags/governance|governance]] tools, discovering that communities seek participation in decision-making rather than just new funding mechanisms*
...
The experiment successfully established operational governance systems using token-based governance, multistakeholder governance patterns, and [[content/tags/daos|DAOs]] structure, all managed through [[content/tags/roles|roles]] implementation with Hats Protocol. Four core team members actively use these systems. ICS launched London's first [[local-nodes|local nodes]] implementation as a Green Pill Network chapter and achieved top 10% ranking in Gitcoin Grants Round 23.
...
- **[[content/tags/impact-attestations|Impact Attestations]]**: Blockchain-based recording of social and environmental contributions to enable transparency and future funding
...
- Configured Hats Protocol tree implementing [[content/tags/roles|roles]] pattern
...
While [[content/tags/blockchain|blockchain]] creates possibility, social adoption requires integration with existing community rhythms, clear value propositions tied to felt needs, and patient cultivation of new practices alongside familiar ones.
...
*This case study contributes to growing knowledge about practical adoption of [[content/tags/decentralization|decentralized]] [[content/tags/coordination|coordination]] patterns for social benefit. We invite readers to adapt these insights for their own contexts and share their experiences to further collective learning.*