...
*ICS experiments with [decentralized](content/tags/decentralization.md#) [governance](content/tags/governance.md#) tools, discovering that communities seek participation in decision-making rather than just new funding mechanisms*
...
The experiment successfully established operational governance systems using token-based governance, multistakeholder governance patterns, and [DAOs](content/tags/daos.md#) structure, all managed through [roles](content/tags/roles.md#) implementation with Hats Protocol. Four core team members actively use these systems. ICS launched London's first [local nodes](content/tags/local-nodes.md#) implementation as a Green Pill Network chapter and achieved top 10% ranking in Gitcoin Grants Round 23.
...
- **[Impact Attestations](content/tags/impact-attestations.md#)**: Blockchain-based recording of social and environmental contributions to enable transparency and future funding
- **[Local nodes](content/tags/local-nodes.md#.md#)**: Green Pill Network chapter to connect local regenerative initiatives with global movement
...
**[Local nodes](content/tags/local-nodes.md#.md#) (Web3 Chapters)**
