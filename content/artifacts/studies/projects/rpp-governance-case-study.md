...
The governance design utilized SuperBenefit's [DAO Primitives framework](../../guides/dao-primitives-framework/index.md#), implementing a multi-stakeholder approach with distinct but interconnected governance layers:
...
1. **Core Primitives**: Building blocks for organizational design:
    ...
    - **[Tasks](../../../tags/tasks.md#.md#)**: Discrete units of work with clear deliverables
...
4. **Task and Role Creation**: Using [roles](../../../tags/roles.md#.md#.md#) and [tasks](../../../tags/tasks.md#.md#.md#) to delegate specific deliverables throughout the project's operational structure. Tasks and Roles were used as primitives to manage all project deliverables.
...
The combination of using existing Cells, or creating new Cells, allowed the operational structure to be flexible to opportunities as they arose. It also provided autonomy to Cells to approach roles and tasks as they chose, while providing transparency via the tools and practices used (Cell State, [Role](../../../tags/roles.md#.md#.md#.md#) and [Task](../../../tags/tasks.md#.md#.md#.md#) definition, transparent decision-making etc)
...
1. **Fiscal Sponsorship and Treasury Management**:
    ...
    - Funds were allocated to a [Safe multi-signature wallet](../../../tags/wallets.md#.md#) controlled by authorized Core Team members
...
2. **Technical Infrastructure**:
    ...
    - **[Safe Wallet](../../../tags/wallets.md#.md#.md#)**: Multi-sig wallet for [treasury management](../../../tags/treasury.md#.md#) with appropriate access controls
...
- **Primitives**: DAOs, [Cells](cells.md#), [Roles](../../../tags/roles.md#), [Tasks](../../../tags/tasks.md#.md#)
...
- Guides: [implementation-guide-multi-stakeholder-governance](../../guides/dao-primitives-framework/dao-primitives-implemention/implementation-guide-multi-stakeholder-governance.md#)
...
- Safe wallet for [treasury management](../../../tags/treasury.md#.md#.md#)
