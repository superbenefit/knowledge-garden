...
For instruction on how to use this template please refer to the [cell-state](/content/artifacts/patterns/Cell%2520state%2520(pattern).md#) pattern, implementation section. 
