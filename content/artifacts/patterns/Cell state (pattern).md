...
This pattern is designed to be used in the creation of [cells](Cells%2520(primitive).md#) as [collaboration](/content/artifacts/guides/dao-primitives-framework/group-scale/Collaboration%2520Scale.md#) scale teams as described in the [DAO Primitives Framework](/content/artifacts/guides/dao-primitives-framework/DAO%2520Primitives%2520Conceptual%2520Framework.md#)
...
**Phase**
The cell state document can serve 5 different purposes depending on the [phase](/content/artifacts/guides/dao-primitives-framework/group-phase/Group%2520Phase.md#) a group is at in its lifecycle: 
1. As a collaborative document to start to gather thoughts and intentions for the group in the [conversation](/content/artifacts/guides/dao-primitives-framework/group-phase/Conversation%2520Phase.md#) phase 
2. As a proposal template for a formal proposal to approve the establishment of the team in the [formation](/content/artifacts/guides/dao-primitives-framework/group-phase/Formation%2520Phase.md#) 
3. As the structure within which to develop and record the team's specific agreements and plans during [organization](/content/artifacts/guides/dao-primitives-framework/group-phase/Organization%2520Phase.md#) phase 
4. As the capture of the ongoing evolving current state of the operating group. Visible, public (to the extent that this is practical) interface for those coordinating with the group through [coordination](/content/artifacts/guides/dao-primitives-framework/group-phase/Coordination%2520Phase.md#)phase 
5. As the final record that archives what the group has achieved and who contributed to these achievements through[completion](/content/artifacts/guides/dao-primitives-framework/group-phase/Completion%2520Phase.md#) phase
...
- **Decision-making**
  ...
  - [Decision-log](Decision%2520log.md#) - recording important decisions in a secure way
  - Tools
...
**External coordination** - the group-state nucleus document allows coordinating entities (other Cells, partners, [community governance](/content/artifacts/patterns/Community%2520Governance.md#) etc) to easily understand what a Cell is trying to achieve, how it is operating internally and what work it is doing. This allows these external entities to make informed decisions about resource allocation and partnership opportunities based on the effectiveness and trustworthiness of the Cell.
...
[Cell State Template](/content/artifacts/patterns/Cell%2520State%2520Template.md#): Use this template as a starting point for designing an appropriate cell state document for a team. Select categories to include from the Components of Cell State section and base
...
- **Phase of development** - a Cell in an early [phase](/content/artifacts/guides/dao-primitives-framework/group-phase/Group%2520Phase.md#) of development may require less specific detail, reflecting its lack of formal structure, compared to an mature operational Cell.
...
In the early phases of development of a Cell ([conversation-phase](/content/artifacts/guides/dao-primitives-framework/group-phase/Conversation%2520Phase.md#.md#) & [formation-phase](/content/artifacts/guides/dao-primitives-framework/group-phase/Formation%2520Phase.md#.md#)] phase) the Cell's state can stored informally in a simple document editor. However as the group implements its formal structure and agreements with other entities in the network, it enters the [organization-phase](/content/artifacts/guides/dao-primitives-framework/group-phase/Organization%2520Phase.md#.md#) phase, and its cell state will need to be stored in a way that produces:
