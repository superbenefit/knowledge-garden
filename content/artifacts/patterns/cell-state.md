...
This pattern is designed to be used in the creation of [cells](cells.md#) as [collaboration](/content/artifacts/guides/dao-primitives-framework/group-scale/collaboration-scale.md#) scale teams as described in the [DAO Primitives Framework](/content/artifacts/guides/dao-primitives-framework/_index.md#)
...
**Phase**
The cell state document can serve 5 different purposes depending on the [phase](/content/artifacts/guides/dao-primitives-framework/group-phase/_index.md#) a group is at in its lifecycle: 
...
- **Phase of development** - a Cell in an early [phase](/content/artifacts/guides/dao-primitives-framework/group-phase/_index.md#) of development may require less specific detail, reflecting its lack of formal structure, compared to an mature operational Cell.
