...
The decider protocol creates a shared common standard for group decision-making that is designed to support [collaboration](/content/artifacts/guides/dao-primitives-framework/group-scale/Collaboration%2520Scale.md#) scale teams to make decisions in a way that:
...
If you are a [collaboration](/content/artifacts/guides/dao-primitives-framework/group-scale/Collaboration%2520Scale.md#) scale team that needs to make decisions quickly, then the decider protocol could be a useful practice to implement. 
...
- [Decision-log](Decision%2520log.md#) - a formal log of decisions, ideally that provides some security and version control
