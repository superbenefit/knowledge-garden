...
- **[[cell|Cell (working group)]]**: A pattern for implementing working groups in DAOs based on the concept of purpose aligned networks of small autonomous teams
- **[[cell|Cell (working group)]]**: A pattern for implementing working groups in DAOs based on the concept of purpose aligned networks of small autonomous teams
- **[[cell-state|Cell state (pattern)]]**: A pattern for creating and managing group state for purpose aligned networks of small autonomous teams
- **[[cell-state|Cell state (pattern)]]**: A pattern for creating and managing group state for purpose aligned networks of small autonomous teams
