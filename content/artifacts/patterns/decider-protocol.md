...
- decision-log - a formal log of decisions, ideally that provides some security and version control
- cells - the decider protocol is often the go-to tool for Cells to use for collaborative decision making
