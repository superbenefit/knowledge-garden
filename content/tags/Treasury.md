...
- **Operational Governance**, carried out by coordinating [Cells](Test%2520Pattern.md#), then has the autonomy to allocate this budgeted capital to specific projects and contributors, enabling agility and innovation at the team scale.

### As the Subject of Governance and Resource Allocation

The treasury is the primary [shared resource](/content/tags/Resources.md#) that a DAO's [governance](/content/tags/Decentralized%2520Governance.md#) processes are designed to manage. Collective decision-making is fundamentally about how to best allocate the treasury's assets to achieve the DAO's goals. Proposals, votes, and debates within a DAO very often revolve around a single question: "How should we use our collective treasury?" This makes the treasury the practical nexus of power, coordination, and purpose within the organization.

## Related Concepts

- [Governance](/content/tags/Decentralized%2520Governance.md#.md#): The set of processes used to manage and allocate the treasury's assets.
- [DAOs](/content/tags/Decentralized%2520Autonomous%2520Organizations%2520(DAOs).md#): The organizations that collectively own and are powered by a treasury.
- [Resources](/content/tags/Resources.md#.md#): The treasury is the primary financial resource pool for a DAO.
...
<<<<<<< HEAD
- [Cells](Test%2520Pattern.md#): The autonomous operational units often funded by the DAO's treasury to perform work.
