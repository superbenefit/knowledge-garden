...
- **[Mutual Aid](./mutual-aid.md#)**: Solidarity provides the ethical foundation for mutual aid practices, which embody solidarity through direct reciprocal support
- **[Community](./community.md#)**: Solidarity creates bonds that strengthen community cohesion and capacity for collective action
- **[Coordination](./coordination.md#)**: Solidarity enables effective coordination by aligning individual and collective interests
- **[Autonomy](./autonomy.md#)**: Solidarity balances collective action with respect for individual and group autonomy
- **[Decentralization](./decentralization.md#)**: Solidarity in decentralized contexts creates resilient networks without centralized control
- **[Values](./values.md#)**: Solidarity functions as both a value that guides action and a practice that embodies values
