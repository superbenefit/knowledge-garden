...
- **[Solidarity](./solidarity.md#)**: The principle of standing together based on shared interests and responsibilities, foundational to mutual aid practices
- **[Autonomy](./autonomy.md#)**: Mutual aid networks emphasize self-determination for both individuals and communities
- **[Decentralization](./decentralization.md#)**: Mutual aid operates through distributed networks rather than centralized control
- **[Coordination](./coordination.md#)**: Mutual aid creates systems for aligning actions without hierarchical management
- **[Community](./community.md#)**: Mutual aid initiatives are grounded in community relationships and collective capacity
- **[Governance](./governance.md#)**: Alternative governance models in mutual aid networks distribute decision-making power across participants
