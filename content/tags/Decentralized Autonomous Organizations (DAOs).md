...
As described in the [DAO Primitives Project](/content/notes/dao-primitives/DAO%2520Primitives%2520Project.md#), DAOs can be understood as "purpose-aligned networks of small autonomous teams" rather than discrete entities. This perspective views DAOs as fluid coordination systems where smaller groups (Cells) self-organize around a shared purpose while maintaining their autonomy. The network provides infrastructure for these groups to discover each other, share resources, and align activities toward common goals without requiring centralized direction.
...
- [Governance](/content/tags/Decentralized%2520Governance.md#) - The frameworks and processes that guide decision-making in DAOs
- [Decentralization](/content/tags/Decentralization.md#.md#) - A key design principle in DAO structures
- [Cells](Test%2520Pattern.md#) - Autonomous teams that form the building blocks of DAO networks
