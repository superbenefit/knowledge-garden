...
For any [DAO](/content/tags/Decentralized%2520Autonomous%2520Organizations%2520(DAOs).md#), the [treasury](/content/tags/Treasury.md#) is its central economic engine, and grants are the primary vehicle for deploying its capital. The [governance](/content/tags/Decentralized%2520Governance.md#) process is often centered on evaluating grant proposals to decide how to allocate these shared [resources](/content/tags/Resources.md#) effectively. A DAO's grants program is a direct reflection of its strategic priorities and its ability to execute on its mission.
...
In the scalable network model described in artifacts/articles/network-evolution 1/Building DAOs as scalable networks, grants are essential for resourcing the small, autonomous teams ([Cells](Test%2520Pattern.md#)) that perform the network's work. Rather than receiving a salary from a central authority, Cells or individuals can submit proposals to the DAO's governance bodies to receive grants for specific projects. This model also supports innovative funding mechanisms like retroactive public goods funding, a type of grant that rewards past work that has proven valuable to the network, thereby incentivizing permissionless innovation.

## Related Concepts

- [Treasury](/content/tags/Treasury.md#.md#): The collective pool of assets from which grants are funded.
- [Governance](/content/tags/Decentralized%2520Governance.md#.md#): The decision-making process through which grant proposals are reviewed and approved.
- [DAOs](/content/tags/Decentralized%2520Autonomous%2520Organizations%2520(DAOs).md#.md#): The organizations that operate grants programs to achieve their goals.
- [Resources](/content/tags/Resources.md#.md#): Grants are the mechanism for allocating a DAO's financial resources to contributors.
- [Cells](Test%2520Pattern.md#): The autonomous teams and working groups that are often the recipients of grants.