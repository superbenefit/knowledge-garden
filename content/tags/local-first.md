...
- **[Decentralization](./decentralization.md#)**: Local-first architectures distribute data control away from centralized platforms toward individual users
- **[Autonomy](./autonomy.md#)**: Local-first software preserves user autonomy over data and digital interactions
- **[Localism](./localism.md#)**: Local-first computing supports localist values of community self-determination and reduced dependence on external systems
- **[Cosmolocalism](./cosmolocalism.md#)**: Local-first enables the cosmolocal principle of local data sovereignty with global knowledge sharing
...
- **[Data Sovereignty](./data-sovereignty.md#)**: Local-first software embodies data sovereignty principles by maintaining user control over personal information
...
- [localism](./localism.md#.md#) - Local-first computing supports community autonomy and place-based solutions
- [cosmolocalism](./cosmolocalism.md#.md#) - Local data sovereignty with global knowledge sharing and coordination
- [decentralization](./decentralization.md#.md#) - Distribution of data control away from centralized platforms