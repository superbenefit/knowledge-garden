...
- [Governance](./governance.md#.md#): Wallets are the tools used to execute governance rights, such as voting and creating proposals.
- [Resources](./resources.md#.md#): A wallet holds the keys that grant control over an individual's on-chain resources.
