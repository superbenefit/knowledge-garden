...
In the [DAO Primitives Framework](/content/tags/Primitives.md#), "Progress" is one of three core dimensions of [Group State](/content/artifacts/guides/dao-primitives-framework/Group%2520State.md#) (alongside [Purpose](/content/tags/Purpose.md#) and [Practice](/content/tags/Practices.md#)). It represents the tools and practices by which a team achieves and demonstrates its activities and outcomes, serving both internal and external coordination needs.
...
Progress documentation in this framework serves a dual purpose: it provides internal structure for team coordination while creating transparency for external entities that need to understand and trust the team's activities. This external transparency is crucial for enabling effective coordination between autonomous [Cells](/content/artifacts/patterns/Cell%2520(working%2520group).md#) within a larger [DAO](/content/tags/Decentralized%2520Autonomous%2520Organizations%2520(DAOs).md#) network.
