...
The [dao-primitives-framework](/content/artifacts/guides/dao-primitives-framework/_index.md#) identifies three fundamental scales at which groups operate within decentralized networks, each with distinct coordination mechanisms and dynamics:
