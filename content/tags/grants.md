...
For any [[/content/tags/daos|DAO]], the [[/content/tags/treasury|treasury]] is its central economic engine, and grants are the primary vehicle for deploying its capital. The [[/content/tags/governance|governance]] process is often centered on evaluating grant proposals to decide how to allocate these shared [[/content/tags/resources|resources]] effectively. A DAO's grants program is a direct reflection of its strategic priorities and its ability to execute on its mission.
...
- [[/content/tags/treasury|Treasury]]: The collective pool of assets from which grants are funded.
- [[/content/tags/governance|Governance]]: The decision-making process through which grant proposals are reviewed and approved.
- [[/content/tags/daos|DAOs]]: The organizations that operate grants programs to achieve their goals.
- [[/content/tags/resources|Resources]]: Grants are the mechanism for allocating a DAO's financial resources to contributors.
