...
- [Treasury](./treasury.md#.md#): The collective pool of assets from which grants are funded.
- [Governance](./governance.md#.md#): The decision-making process through which grant proposals are reviewed and approved.
- [DAOs](./daos.md#.md#): The organizations that operate grants programs to achieve their goals.
- [Resources](./resources.md#.md#): Grants are the mechanism for allocating a DAO's financial resources to contributors.
