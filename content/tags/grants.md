...
For any [[./daos|DAO]], the [[./treasury|treasury]] is its central economic engine, and grants are the primary vehicle for deploying its capital. The [[./governance|governance]] process is often centered on evaluating grant proposals to decide how to allocate these shared [[./resources|resources]] effectively. A DAO's grants program is a direct reflection of its strategic priorities and its ability to execute on its mission.
...
- [[./treasury|Treasury]]: The collective pool of assets from which grants are funded.
- [[./governance|Governance]]: The decision-making process through which grant proposals are reviewed and approved.
- [[./daos|DAOs]]: The organizations that operate grants programs to achieve their goals.
- [[./resources|Resources]]: Grants are the mechanism for allocating a DAO's financial resources to contributors.
