...
- [Governance](./governance.md#.md#): The set of processes used to manage and allocate the treasury's assets.
- [DAOs](./daos.md#): The organizations that collectively own and are powered by a treasury.
- [Resources](./resources.md#.md#): The treasury is the primary financial resource pool for a DAO.
