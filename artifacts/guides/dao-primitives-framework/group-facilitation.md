...
Based on the articulated [purpose](tags/purpose.md) and mapped requirements, the design team must narrow in on a particular [governance](tags/governance.md) approach from the many available options for decentralized governance. The [community-governance](artifacts/patterns/community-governance.md) pattern outlines several approaches worth considering, but the choice will depend on multiple factors including the specific needs of the group, the nature of their work, and the structure and culture of existing [networks](tags/networks.md) they coordinate with.
...
Using the [group-primitives](artifacts/guides/dao-primitives-framework/group-primitives/index.md) as building blocks:
...
Follow the [group-phase](artifacts/guides/dao-primitives-framework/group-phase/index.md) model to ensure implementation steps are appropriate for each phase of the group's evolution:
