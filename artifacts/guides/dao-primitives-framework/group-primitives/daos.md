...
**[Governance](tags/governance.md) [Primitives](tags/primitives.md)**: In the DAO Primitives Framework, DAOs utilize the other 3 [group-primitives](artifacts/guides/dao-primitives-framework/group-primitives/index.md) to implement their governance and operational design:
