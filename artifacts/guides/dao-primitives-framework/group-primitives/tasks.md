...
**Contributor Coordination Tasks**: Tasks used by [Cells](cells.md) to engage external contributors, often working in conjunction with [Roles](artifacts/guides/dao-primitives-framework/group-primitives/roles.md) to create clear [agreements](tags/agreements.md) about specific contributions and deliverables.
