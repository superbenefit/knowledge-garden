...
The governance design utilized SuperBenefit's [[artifacts/guides/dao-primitives-framework/index|DAO Primitives framework]], implementing a multi-stakeholder approach with distinct but interconnected governance layers:
